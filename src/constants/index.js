      ...
      children: [
        {
          ...
          position: "top-5 left-10",
          description: [
            "Echo Motions is a gesture-controlled music player that uses hand tracking to control playback.",
            "The project uses computer vision and machine learning to detect hand gestures in real-time.",
            "Built with Python, OpenCV, and MediaPipe for gesture recognition and music control.",
            "Repository: https://github.com/ayaskant007/Echo-Motions",
          ],
        },
        {
          id: 2,
